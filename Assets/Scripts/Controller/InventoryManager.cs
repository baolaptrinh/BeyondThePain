...
namespace SA{
    public class InventoryManager : MonoBehaviour {
        ...
        public RuntimeWeapon rightHandWeapon; // gameObject mới sẽ được tạo dựa trên danh sách chuỗi chứa ID của vũ khí
        ...
        {
            //____________Khởi tạo Parry Collider______________
            ...
            if (r_r_weapons.Count > 0)
            {
                ...
                // Chuyển giá trị từ List<RuntimeWeapon> sang biến tham chiếu RuntimeWeapon dựa trên r_index
            ...
            if (r_l_weapons.Count > 0)
            {
                ...
                // Chuyển giá trị từ List<RuntimeWeapon> sang biến tham chiếu RuntimeWeapon dựa trên l_index
            ...
            //____________Khởi tạo phép thuật___________________
            ...
            //____________Khởi tạo vật phẩm tiêu hao______________
            ...
            //______________ Khởi tạo Colliders_______________
        ...
        {
            // Tại thời điểm này, l_index & r_index vẫn = 0, nhưng sau khi hàm này được gọi, giá trị của chúng sẽ tăng lên. Do đó, tên vũ khí tiếp theo trong List sẽ được phát hiện.
            if (isLeft)
            {
                if (l_index < r_l_weapons.Count - 1)
                    l_index++;
        ...
        public RuntimeWeapon WeaponToRuntimeWeapon(Weapon w, bool isLeft = false) {
            ...
            // Sau khi thêm RuntimeWeapon, tắt model đã tạo và để hàm EquipWeapon xử lý việc bật/tắt model vũ khí.
        ...
        //_________Phép__________________
