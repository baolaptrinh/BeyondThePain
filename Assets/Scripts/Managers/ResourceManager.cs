...
namespace SA {
    public class ResourceManager : MonoBehaviour
    {
        ...
        // Tải các ID vũ khí từ ScriptableObject và lưu trữ trong từ điển weapon_ids.
        void LoadWeaponIds() {
        ...
        // Trả về một đối tượng Weapon từ Resource với tên tương ứng.
        ...
        // --------------------------Spells-----------------------------
        // Tải các ID phép thuật từ ScriptableObject và lưu trữ trong từ điển spell_ids.
        void LoadSpellIds()
        {
        ...
        // Lấy ID của phép thuật dựa trên tên của nó từ từ điển spell_ids.
